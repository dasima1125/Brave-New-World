...
public class TestLunch_Beta : MonoBehaviour
{
    ...
    [Tooltip("True = single , False = all")]
    public bool SelectSingleOrAll;
    Rigidbody2D rb;
    ...
    public void LaunchTest()
    {
        ...
        if(SelectSingleOrAll) TrackLogicInjector();
    ...
    void TrackLogicInjector()
    {
        switch (GuidanceType)
        {
            ...
            case GuidanceAuthority.Command:
                ...
                //Projectile_Command.Init(InjectLogic, projectileSpeed, maxAngularVelocity, projectileLife, navigationConstant);
                break;
        }
    ...
    void AllFire()
    {
        foreach (TrackLogicType Logic in Enum.GetValues(typeof(TrackLogicType)))
        {
            ...
            //Projectile_Command2.Init(Logic, projectileSpeed, maxAngularVelocity, projectileLife, navigationConstant);
        }
    }
    ...
    {
        return new TNS2DData(Target.GetComponent<Rigidbody2D>());
    }
    void OnDrawGizmos()
    {
